...
@RestController ("EncuestaControllerV2-Computer") //se agrego ("EncuestaControllerV1")  para definir la version v1
...
public class ComputeResultController {
    ...
    @GetMapping("/calcularResultado")  //GET: http://localhost:8080/v2/encuesta/calcularResultado?encuestaId=1        otra forma en params en key agregar: encuestaId  y en value agregar: 2 para evitar agregar en la url: ?encuestaId=1
